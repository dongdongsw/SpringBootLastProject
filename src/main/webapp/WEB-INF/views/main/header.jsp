                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="yummyfood-nav">
                            <ul class="navbar-nav" id="yummy-nav">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" id="yummyDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">제주 여행</a>
                                    <div class="dropdown-menu" aria-labelledby="yummyDropdown">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="yummyDropdown">
                                        <a class="dropdown-item" href="/main">한식</a>
                                ...
                                <sec:authorize access="isAuthenticated()">
	                                ...
	                                <li class="nav-item">
	                                   <a class="nav-linQk" href="/mypage/mypage_main">마이페이지</a>
	                               	</li>
                               		</sec:authorize>
                               		<sec:authorize access="hasRole('ADMIN')">
	                                <li class="nav-item">
	                                   <a class="nav-link" href="/admin/admin_main">관리자 페이지</a>
	                                </li>
	                                </sec:authorize>
                               </sec:authorize>	
                            </ul>
